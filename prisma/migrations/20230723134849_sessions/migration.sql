...
INSERT INTO "new_Order" ("address", "city", "country", "createdAt", "id", "name", "phone", "total", "updatedAt", "userId", "zipCode") SELECT "address", "city", "country", "createdAt", "id", "name", "phone", "total", "updatedAt", "userId", "zipCode" FROM "Order";
DROP TABLE "Order";
...
CREATE TABLE "new__WishedProducts" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,
...
INSERT INTO "new__WishedProducts" ("A", "B") SELECT "A", "B" FROM "_WishedProducts";
DROP TABLE "_WishedProducts";
ALTER TABLE "new__WishedProducts" RENAME TO "_WishedProducts";
