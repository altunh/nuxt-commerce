...
INSERT INTO "new_Product" ("createdAt", "description", "id", "image", "keywords", "name", "price", "updatedAt") SELECT "createdAt", "description", "id", "image", "keywords", "name", "price", "updatedAt" FROM "Product";
DROP TABLE "Product";
